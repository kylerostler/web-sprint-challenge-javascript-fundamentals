...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    // create an array to push to called displayNames
    let displayNames = [];
    // loop through array
    array.forEach(function(item){
      displayNames.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`);
    });
    // return scientific name and animal name as an array called displayNames
    // return them as strings
    return displayNames;
  }
  
  console.log('topic 2 task 1', animalNames(zooAnimals));
  ...
  */
  ...
  function lowerCaseNames(array){
    // receive an array and convert names to lower case
    const lowerCaseNames = array.map(function(item){
      return item.animal_name.toLowerCase();
    });
    return lowerCaseNames;
  }
  console.log('top2 task 2', lowerCaseNames(zooAnimals));
  ...
  */
  ...
  function lowPopulationAnimals(array){
    // receive an array and sort through it to get animals with population less than 5
    const lowPopCount = array.filter(function(item){
      return item.population < 5;
    })
    // return a new array with those animals
    return lowPopCount;
  }
  
  console.log('top2 task 3', lowPopulationAnimals(zooAnimals));
  ...
  */
  ...
  function USApop(array){
    // receive an array and find the total population count of all the animals
    const totalAnimalPop = array.reduce(function(acc, item){
      return acc + item.population;
    },0)
    return totalAnimalPop;
  }
  console.log('top2 task 4', USApop(zooAnimals));
  ...
  */
  ...
  //receive three param a, b, and callback
